            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        ...
                        <p class="text-muted">Une boutique mono-produit est une boutique qui propose des produits sur le plus souvent sa page d'accueil. </p>
                    </div>
                    ...
                    <?php foreach ($Produits as $produit) :  ?>
                        ...
                        <div class="col">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <p class="card-text"><?= substr($produit->description, 0, 250);  ?></p>
